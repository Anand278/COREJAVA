...
check given rollno is of SchoolStudent or of CollegeStudent. 
...
class StudentDemo{
    public static void main(String[] agrs){
            ...
            if(searchRollNo == arrCollegeStudent[i].rollno){
                ...
                for(int j=0 ; j< arrSchoolStudent.length ; j++){
                    if(searchRollNo == arrSchoolStudent[i].rollno){
                        System.out.println("Student is of School Student !!");
                        flag = 0;
                        break;
                    }
        ...
        int gradeAStudent = gradeCollegeStudent+gradeSchoolStudent;
        System.out.println("Students are having A grade : "+gradeAStudent);
    }
}